...
<table width="80%" border="0" align="center" cellpadding="7" cellspacing="3">
    ...
    <tr>    
      ...
      <td align="center" valign="middle" nowrap="nowrap" style="font-size: 12px"><a href="<?php echo base_url();?>index.php/admin/listPaymentMember/<?php echo $m['memberId'];?>" class="listLoanMember fancybox.iframe">
